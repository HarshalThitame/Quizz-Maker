<%-- 
    Document   : QuizList
    Created on : 13-Oct-2022, 5:51:16 PM
    Author     : harshal
--%>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="container m-0">
                        <h2 class="text-center fs-1 py-4 "><img src="img/quiz.svg" alt="alt"/> Quiz List</h2>
                            ...
                            <table class="table table-bg text-center table-bordered table-striped mb-0 m-0 p-0">
                                ...
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        List<Quiz> quizlist = dao.getAllQuiz(id);
